...
import { FaTrash, FaUpload, FaPlus, FaTimes } from 'react-icons/fa';
...
export default function EditListing() {
  ...
  const handleAddImages = (e) => {
    ...
    const newPrvw = files.map(f => URL.createObjectURL(f));
    setNewImages(prev => [...prev, ...files]);
    setNewPreviews(prev => [...prev, ...newPrvw]);
  };
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-dark">Edit Listing</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className={sectionClass}>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <textarea {...register('description', { required: true })} rows={5} className={`${inputClass} resize-none`} />
            </div>
          </div>
        </div>
        ...
        <div className={sectionClass}>
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            <div>
              ...
              <input {...register('price', { required: true })} type="number" className={inputClass} />
            </div>
            <div>
          ...
          <div className="space-y-5">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <select {...register('locality', { required: true })} className={inputClass}>
        ...
        <div className={sectionClass}>
          ...
          {existingImages.length > 0 && (
            <div className="mb-5">
              <p className="text-sm font-medium text-text-sub mb-3">Existing Images</p>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-3 mt-4">
              {newPreviews.map((src, i) => (
                <div key={i} className="relative group aspect-square rounded-xl overflow-hidden border border-border">
                  ...
                  <button type="button" onClick={() => removeNewImage(i)} className="absolute top-2 right-2 w-6 h-6 bg-red-500 text-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <div className="flex gap-4">
          ...
          <button type="button" onClick={() => navigate('/agent/listings')} className="btn-outline py-3 px-8">Cancel</button>
        </div>
      </form>
    </div>
  );
