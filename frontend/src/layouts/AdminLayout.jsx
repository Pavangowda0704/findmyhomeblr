    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <header className="bg-white border-b border-border h-16 fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-4 sm:px-6 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/" className="flex items-center gap-2.5">
            ...
            <div className="hidden sm:flex flex-col leading-tight">
              ...
              <span className="text-[9px] text-text-sub uppercase tracking-widest">Admin Panel</span>
            </div>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs bg-primary text-dark font-bold px-2.5 py-1 rounded-full">Admin</span>
          <button
            onClick={handleLogout}
            title="Logout"
